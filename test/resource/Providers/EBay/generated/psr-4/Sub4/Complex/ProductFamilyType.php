...
{
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\ProductType | A transient header that describes the current search results. Contains a
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\ProductType | A set of products (within the same product family) that match the search query.
     */
