...
class FlatShippingPreferencesType
{
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\AmountType | If the user specifies ChargeAmountForEachAdditionalItem for FlatShippingRateOption,
     * then this value is used to specify how much to charge for each additional item.
     */
    public $AmountPerAdditionalItem;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\AmountType | If the user specifies DeductAmountFromEachAdditionalItem for FlatShippingRateOption,
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\FlatRateInsuranceRangeCostType | For the given range, specifies the cost of insurance. If the InsuranceOption is either
     * Optional or Required, then 6 instances of this field must be specifies, one for each
     * cost range.
     */
    public $FlatRateInsuranceRangeCost;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\FlatShippingRateOptionCodeType | Specifies how the user wants flat-rate shipping to be calculated.
     */
