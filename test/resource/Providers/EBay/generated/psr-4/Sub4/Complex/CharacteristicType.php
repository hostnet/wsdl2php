...
class CharacteristicType
{
    ...
    public $DisplayUOM;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\LabelType | Applicable when working with Pre-filled Item Information (Catalogs) functionality.
    ...
    public $Label;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\SortOrderCodeType | Applicable when working with Pre-filled Item Information (Catalogs) functionality. Indicates
