...
class NameValueListArrayType
{
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\NameValueListType | A name and corresponding value (a name/value pair).<br> <br> In the GetSearchResults
     * response, this is only returned for applicable items when the value of IncludeCondition
     * was true in the GetSearchResults request, or when SearchRequest was used to perform
