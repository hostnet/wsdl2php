...
class TransactionStatusType
{
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\CheckoutStatusCodeType | Indicates the current status of the checkout process for the transaction.
     */
    public $checkoutstatus;
    /**
     * @var dateTime | Indicates date and time a transaction's status or incomplete state was last updated
     * (in GMT).
     */
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\CompleteStatusCodeType | Indicates whether the transaction process is complete or incomplete.
     */
