...
class FeedbackSummaryType
{
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\FeedbackPeriodArrayType | Bid retractions count, for multiple predefined time periods preceding the call. Returned
     * if no detail level is specified.
     */
    public $BidRetractionFeedbackPeriodArray;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\FeedbackPeriodArrayType | Negative feedback entries count, for multiple predefined time periods preceding the
     * call. Returned if no detail level is specified.
     */
    public $NegativeFeedbackPeriodArray;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\FeedbackPeriodArrayType | Neutral feedback entries count, for multiple predefined time periods preceding the call.
     * Returned if no detail level is specified.
     */
    public $NeutralFeedbackPeriodArray;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\FeedbackPeriodArrayType | Positive feedback entries count, for multiple predefined time periods preceding the
     * call. Returned if no detail level is specified.
     */
    public $PositiveFeedbackPeriodArray;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\FeedbackPeriodArrayType | Total feedback score, for multiple predefined time periods preceding the call. Returned
     * if no detail level is specified.
     */
    public $TotalFeedbackPeriodArray;
    /**
     * @var int | Number of neutral comments received from suspended users. Returned if no detail level
     * is specified.
     */
