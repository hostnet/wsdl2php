...
class StoreCustomListingHeaderLinkType
{
     ...
     * or for a custom page, and it is not needed  when the LinkType property is "AboutMe"
     * or "None".
     */
    public $LinkID;
    /**
    ...
    public $Order;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\StoreCustomListingHeaderLinkCodeType | Type of link to include in the custom listing header.
     */
    public $LinkType;
    /**
