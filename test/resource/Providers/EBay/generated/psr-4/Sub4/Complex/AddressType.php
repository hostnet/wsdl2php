...
class AddressType
{
    ...
    public $Phone;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\CountryCodeType | Standard ISO code for the country of the user's primay telephone phone number. For Classifed
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\CountryCodeType | Standard ISO code for the country of a user's secondary telephone phone number. For
    ...
    public $AddressID;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\AddressOwnerCodeType | The realm to which the address belongs (e.g. eBay vs PayPal). For GetOrders, applies
     * only to Half.com.
     */
    public $AddressOwner;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\AddressStatusCodeType | PayPal address status. Not applicable to Half.com.
     */
    ...
    public $CompanyName;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\AddressRecordTypeCodeType | Indicates the nature of the address (e.g., residential or business). Not applicable
     * to Half.com.
     */
