...
class ApiAccessRuleType
{
     ...
     * period ends, further calls will be refused until the next period starts. Possible values:
     * -1 (Periodic limit not enforced, could be any negative integer), 0 (Calendar month),
     * 30 (Number of days, could be any positive integer). If the period is based on the calendar
     ...
     * on Pacific Daylight Time, the GMT value returned would be 2005-06-29T07:00:00.000Z If
     * the period begins on December 29 in 2005 when California is on Pacific Standard Time,
     * the GMT value returned would be 2005-12-29T08:00:00.000Z. Only returned when the eBay
    ...
    public $ModTime;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\AccessRuleCurrentStatusCodeType | Your application's current status for this rule, including whether the rule is set for
     * your application and whether the application has exceeded its daily or hourly limit.
     */
    public $RuleCurrentStatus;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\AccessRuleStatusCodeType | The status of the access rule, including whether the rule is turned on or off and whether
