...
{
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\DomainHistogramType | Indicates the quantity of items and catalog products that fall into departments, aisles,
    ...
    public $itemarray;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\ProductArrayType | Contains a list of eBay catalog products have been used to pre-fill listings that match
     * the criteria specified in the request. The sort order is controlled by the value of
     * ProductSort in the request. Only returned when matching data is found and ProductDetails
     * is Coarse (the default) or Fine. To determine which products are currently available
     * in a given domain, specify the DepartmentName, AisleName, or ProductTypeName in the request.
     */
    public $productarray;
    /**
