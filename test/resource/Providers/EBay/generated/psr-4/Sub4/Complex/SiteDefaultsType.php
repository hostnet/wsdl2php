...
class SiteDefaultsType
{
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\ListingDurationReferenceType | Specifies the ID of a set of default durations for a certain type of listing. The actual
    ...
    /**
     * @var boolean | Specifies the default site setting for whether categories allow DutchBIN. True means
     * best offers are allowed site-wide, unless a specific category overrides the setting.
     */
    ...
    /**
     * @var boolean | Specifies the default site setting for whether categories allow the ProPack feature
     * (a feature pack). True means ProPack is allowed site-wide, unless a specific category
     * overrides the setting.
     */
    public $ProPackEnabled;
    /**
     * @var boolean | Specifies the default site setting for whether categories allow the BasicUpgradePack
    ...
    /**
     * @var boolean | Specifies the default site setting for whether categories allow the ValuePack feature
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\AdFormatEnabledCodeType | Specifies the default site setting for whether categories allow the Ad Format feature.
     * True means the feature is allowed site-wide, unless a specific category overrides the
     * setting.
     */
    public $AdFormatEnabled;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\DigitalDeliveryEnabledCodeType | eBay enables you to list and sell digital files (such as Adobe PDF files) or information
    ...
    /**
     * @var boolean | Specifies the default site setting for whether categories allow auto decline for best
    ...
    /**
     * @var boolean | Specifies the default site setting for whether LocalMarketRegularSubscription feature
     * is supported for this category.
     */
    public $LocalMarketRegularSubscription;
    /**
     * @var boolean | Specifies the default site setting for whether LocalMarketPremiumSubscription feature
     * is supported for this category.
     */
    public $LocalMarketPremiumSubscription;
    /**
     * @var boolean | Specifies the default site setting for whether LocalMarketNonSubscription feature is
    ...
    /**
     * @var boolean | Specifies whether most categories on the site require a listing to include the Item
    ...
    /**
     * @var boolean | Specifies the default site setting for whether categories allow seller-level contact
    ...
    /**
     * @var boolean | Specifies the default site setting for whether the Transaction Confirmation Request
     * feature is supported for this category.
     */
    public $TransactionConfirmationRequestEnabled;
    /**
     * @var boolean | Specifies the default site setting for whether categories allow the Store Inventory
     * Format feature. True means the feature is allowed site-wide, unless a specific category
     * overrides the setting.
     */
    public $StoreInventoryEnabled;
    /**
     * @var boolean | Specifies the default site setting for whether categories allow the addition of Skype
    ...
    /**
     * @var string | Specifies the supported local listing distances for users who have not subscribed to
