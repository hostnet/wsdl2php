 ...
 \Controle\Hostnet\Namesp\Sub4\Complex\AbstractResponseType
{
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\MyMessagesSummaryType | Summary data for a given user's alerts and messages. This includes the numbers of new
    ...
    public $Summary;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\MyMessagesAlertArrayType | Contains the alert information for each alert specified in AlertIDs. The amount and
    ...
    public $Alerts;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\MyMessagesMessageArrayType | Contains the message information for each message specified in MessageIDs. The amount
