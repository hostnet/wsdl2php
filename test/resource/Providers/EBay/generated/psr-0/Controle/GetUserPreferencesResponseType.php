...
class GetUserPreferencesResponseType extends \Controle\AbstractResponseType {
	...
	/**
	 * @var \Controle\CombinedPaymentPreferencesType | The user's combined payment preferences to be set. When you change these preferences, it
	...
	/**
	 * @var \Controle\eBxOptInPreferenceType | If true: The seller wants their eligible eBay listings to be included on eBay Express (in
