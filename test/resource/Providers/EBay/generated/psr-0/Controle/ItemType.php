...
class ItemType
{
	...
	/**
	 * @var \Controle\LookupAttributeArrayType | Use this as a shortcut for specifying the Item Condition attribute by name instead of by
	...
	/**
	 * @var \Controle\CharityType | Identifies a Giving Works listing and the benefiting nonprofit charity organization selected
	...
	public $Description;
	/**
	 * @var \Controle\DescriptionReviseModeCodeType | If you are changing the description of an item, specifies whether the new next is an addition,
	 * a replacement, etc.
	 */
	...
	public $GiftIcon;
	/**
	 * @var \Controle\GiftServicesCodeType | Optional gift services that the seller is offering if the buyer chooses to purchase the
	...
	/**
	 * @var \Controle\ListingDesignerType | Contains the detail data for the Listing Designer theme and template (if either are used),
	...
	/**
	 * @var \Controle\ListingEnhancementsCodeType | Describes listing upgrades that sellers can select for a fee, such as the BoldTitle upgrade.
	...
	/**
	 * @var \Controle\CategoryType | Category ID for the first (or only) category in which the item is listed (or will be listed,
	...
	public $RelistLink;
	/**
	 * @var \Controle\AmountType | The lowest price at which the seller is willing to sell the item. (StartPrice must be lower
	...
	public $ScheduleTime;
	/**
	 * @var \Controle\CategoryType | ID for second category in which the item is listed (also see Item.PrimaryCategory). <br> <br> <b>For
	...
	/**
	 * @var \Controle\ShippingOptionCodeType | Previous behavior: Indicates where the seller is willing to ship the item. Default is SiteOnly.
	...
	/**
	 * @var \Controle\ShippingTermsCodeType | Previous behavior: Indicates who pays the shipping costs for the item(s), the buyer or
	...
	public $Site;
	/**
	 * @var \Controle\AmountType | The original price of the item at listing or re-listing time. If this value changes when
	...
	public $Title;
	/**
	 * @var \Controle\UUIDType | Universally unique constraint tag. Use UUID to ensure that you only list a particular item
	...
	/**
	 * @var \Controle\BuyerRequirementsType | Container for buyer requirements. Individual buyer requirements cannot be modified or added.
	...
	/**
	 * @var \Controle\SKUType | Identifier defined and used by a seller to identify an item. The seller can use a SKU to
	...
	public $SkypeID;
	/**
	 * @var \Controle\SkypeOptionCodeType | Regardless of the request version you specify, if you use SkypeOption when listing an item,
	 * it is mapped to the corresponding values of SkypeContactOption.
	 */
	public $SkypeOption;
	/**
	 * @var \Controle\SkypeContactOptionCodeType | Specifies the Skype contact options supported. Requires that SkypeEnabled is set to true.
