...
class AccountEntryType
{
	...
	/**
	 * @var \Controle\AccountDetailEntryCodeType | Indicates the type of transaction or reason for the transaction. For example, a value of
	...
	public $Memo;
	/**
	 * @var \Controle\AmountType | Net fees that are assessed by eBay, excluding additional surchargesand VAT (if any). Returned
