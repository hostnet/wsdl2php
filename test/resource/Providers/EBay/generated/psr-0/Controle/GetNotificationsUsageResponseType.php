 ...
 * is included.
 */
class GetNotificationsUsageResponseType extends \Controle\AbstractResponseType {
	/**
	...
	/**
	 * @var \Controle\NotificationStatisticsType | Summary information about number of notifications that were successfully delivered, queued,
