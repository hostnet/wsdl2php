 ...
 */
class GetSellerPaymentsResponseType extends \Controle\AbstractResponseType {
	/**
	...
	/**
	 * @var \Controle\SellerPaymentType | Information about a single payment that matches the criteria in the request. A payment
