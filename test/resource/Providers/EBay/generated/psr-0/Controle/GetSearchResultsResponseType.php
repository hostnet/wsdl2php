 ...
 */
class GetSearchResultsResponseType extends \Controle\AbstractResponseType {
	/**
	 * @var \Controle\SearchResultItemArrayType | Contains the returned item listings, if any. The data for each listing is returned in an
	 * ItemType object.
	 */
