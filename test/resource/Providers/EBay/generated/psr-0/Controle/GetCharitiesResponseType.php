 ...
 * in the request.
 */
class GetCharitiesResponseType extends \Controle\AbstractResponseType {
	/**
	 * @var \Controle\CharityInfoType | Identifies a Giving Works listing and the benefiting nonprofit charity organization selected
