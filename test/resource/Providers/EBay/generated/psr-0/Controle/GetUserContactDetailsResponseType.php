 ...
 */
class GetUserContactDetailsResponseType extends \Controle\AbstractResponseType {
	/**
	...
	public $UserID;
	/**
	 * @var \Controle\AddressType | Contact information for the requested contact. Note that the email address is NOT returned.
	 */
