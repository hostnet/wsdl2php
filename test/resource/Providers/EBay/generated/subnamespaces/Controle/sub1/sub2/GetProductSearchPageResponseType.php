 ...
 */
class GetProductSearchPageResponseType extends \Controle\sub1\sub2\AbstractResponseType {
	/**
	...
	/**
	 * @var \Controle\sub1\sub2\ProductSearchPageType | A list of catalog search criteria and sort keys associated with a catalog-enabled category, plus
