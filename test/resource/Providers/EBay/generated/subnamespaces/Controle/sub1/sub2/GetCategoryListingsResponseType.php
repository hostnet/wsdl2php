...
class GetCategoryListingsResponseType extends \Controle\sub1\sub2\AbstractResponseType {
	/**
	...
	public $Category;
	/**
	 * @var \Controle\sub1\sub2\CategoryArrayType | Collection of the sub-categories that are child to the category indicated in Category.
