...
class CategoryType
{
	...
	/**
	 * @var \Controle\sub1\sub2\ExtendedProductFinderIDType | Returned from GetCategory2CS calls with compatibility level 369 and higher. Supports listing
	...
	/**
	 * @var \Controle\sub1\sub2\CharacteristicsSetType | Returned from GetCategory2CS calls. A list of one or more characteristics sets mapped to
