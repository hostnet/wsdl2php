...
class BestOfferType {
	/**
	 * @var \Controle\sub1\sub2\BestOfferIDType | An id to distinguish this best offer from other best offers made on the item.
	 */
	public $BestOfferID;
	/**
	...
	public $Buyer;
	/**
	 * @var \Controle\sub1\sub2\AmountType | The amount of the best offer.
	 */
	public $Price;
	/**
	 * @var \Controle\sub1\sub2\BestOfferStatusCodeType | Indicates the user's registration/user status. To be eligible to list on Express, a seller's
	...
	/**
	 * @var \Controle\sub1\sub2\BestOfferTypeCodeType | The best offer type.
	 */
