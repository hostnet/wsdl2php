 ...
 */
class GetSearchResultsResponseType extends \Controle\sub1\sub2\AbstractResponseType {
	/**
	 * @var \Controle\sub1\sub2\SearchResultItemArrayType | Contains the returned item listings, if any. The data for each listing is returned in an
	 * ItemType object.
	 */
	...
	/**
	 * @var \Controle\sub1\sub2\BuyingGuideDetailsType | Contains URLs and other information about relevant buying guides (if any), as well as the
	...
	/**
	 * @var \Controle\sub1\sub2\ExpansionArrayType | Returned for the US site, US eBay Motors site, and Canada site; returned for other international
	...
	/**
	 * @var \Controle\sub1\sub2\ExpansionArrayType | Can be returned if the request specifies that ExpandSearch is true. Provides additional
	...
	/**
	 * @var \Controle\sub1\sub2\SpellingSuggestionType | Suggestion for a different spelling of the search term or terms, along with the number
	...
	/**
	 * @var \Controle\sub1\sub2\RelatedSearchKeywordArrayType | Container for keywords related to the original keywords in the request. Can be returned
