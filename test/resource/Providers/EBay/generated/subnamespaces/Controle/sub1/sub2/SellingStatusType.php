...
class SellingStatusType {
	...
	public $BidCount;
	/**
	 * @var \Controle\sub1\sub2\AmountType | Smallest amount a bid must be above the current high bid. Only applicable to competitive-bidding
	...
	public $BidIncrement;
	/**
	 * @var \Controle\sub1\sub2\AmountType | Converted value of the CurrentPrice in the currency of the site that returned this response.
	 * For active items, refresh the listing's data every 24 hours to pick up the current conversion
	 * rates.
	 */
	public $ConvertedCurrentPrice;
	/**
	 * @var \Controle\sub1\sub2\AmountType | For competitive-bidding listings (Chinese and Dutch auctions), current minimum asking price
	...
	public $CurrentPrice;
	/**
	 * @var \Controle\sub1\sub2\UserType | For single-item (Quantity = 1) auction listings that have ended and have a winning bidder,
	...
	public $LeadCount;
	/**
	 * @var \Controle\sub1\sub2\AmountType | Smallest amount the next bid on the item can be. Returns same value as Item.StartPrice
