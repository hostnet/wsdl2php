...
class SellerType
{
	...
	/**
	 * @var \Controle\sub1\sub2\CurrencyCodeType | Currency type in which the user is billed seller fees.
	 */
	...
	/**
	 * @var \Controle\sub1\sub2\MerchandizingPrefCodeType | Indicates whether the seller participates in the Merchandising Manager feature. If so,
	...
	/**
	 * @var \Controle\sub1\sub2\SellerGuaranteeLevelCodeType | Maximum level of Motor's Seller guarantee the seller is authorized to offer.
	 */
	public $sellerguaranteelevel;
	/**
	 * @var \Controle\sub1\sub2\SellerLevelCodeType | The user's eBay PowerSeller tier. Possible values are enumerated in the SellerLevelCodeType
	 * code list.
	 */
	public $sellerlevel;
	/**
	...
	/**
	 * @var \Controle\sub1\sub2\SchedulingInfoType | Container for scheduling limits for the user. Conveys the minimum and maximum minutes the
	...
	/**
	 * @var \Controle\sub1\sub2\ExpressSellerRequirementsType | Contains detailed data relating to whether a seller qualifies as an Express seller. Whether
