...
class UserType
{
	...
	/**
	 * @var \Controle\sub1\sub2\FeedbackRatingStarCodeType | Visual indicator of user's feedback score. See FeedbackRatingStarCodeType for specific
	 * values.
	 */
	...
	public $NewUser;
	/**
	 * @var \Controle\sub1\sub2\AddressType | Registration address for a user.<br> <br> <b>GetUser:</b> eBay returns complete RegistrationAddress
	...
	public $Site;
	/**
	 * @var \Controle\sub1\sub2\UserStatusCodeType | Indicates the user's registration/user status. To be eligible to list on Express, a seller's
	 * status must be Confirmed. See "eBay Express" in the eBay Web Services guide.
	 */
	public $Status;
	/**
	 * @var \Controle\sub1\sub2\UserIDType | Unique eBay user ID for the user.<br> <br> In GetSearchResultsExpress, only returned when
	...
	/**
	 * @var \Controle\sub1\sub2\VATStatusCodeType | Indicates whether or not the user is subject to VAT. Users who have registered with eBay
	 * as VAT-exempt are not subject to VAT. See documentation on Value-Added Tax (VAT).
	 */
	public $VATStatus;
	/**
	 * @var \Controle\sub1\sub2\BuyerType | Contains information about the user as a buyer, such as the shipping address. See BuyerType
	...
	public $BuyerInfo;
	/**
	 * @var \Controle\sub1\sub2\SellerType | Contains information about the user as a seller, such as whether the seller is authorized
	 * to list Live Auctions items or opts to have items cross-promoted. See SellerType for its
	 * child elements.
	 */
	public $SellerInfo;
	/**
	 * @var \Controle\sub1\sub2\CharityAffiliationsType | Contains information about the seller's charity affliations. Returned if the user is affiliated
	...
	/**
	 * @var \Controle\sub1\sub2\CharitySellerType | Contains information about the registered charity seller. Registered charity sellers have
	...
	/**
	 * @var \Controle\sub1\sub2\PayPalAccountLevelCodeType | The user's PayPal account level. Only returned for the user identified in eBayAuthToken.
	...
	/**
	 * @var \Controle\sub1\sub2\PayPalAccountTypeCodeType | The user's PayPal account type. Only returned for the user identified in eBayAuthToken.
	...
	/**
	 * @var \Controle\sub1\sub2\PayPalAccountStatusCodeType | The user's PayPal account status. Only returned for the user identified in eBayAuthToken.
	...
	/**
	 * @var \Controle\sub1\sub2\EBaySubscriptionTypeCodeType | Specifies the subscription level for a user.
	 */
	...
	public $MotorsDealer;
	/**
	 * @var \Controle\sub1\sub2\SellerPaymentMethodCodeType | Indicates the method the seller selected to pay eBay with for the account. The payment
	...
	/**
	 * @var \Controle\sub1\sub2\BiddingSummaryType | Contains information about the user as a bidder on a certain item. Returned for GetAllBidders
