 ...
 */
class GetBestOffersResponseType extends \Controle\sub1\sub2\AbstractResponseType {
	/**
	 * @var \Controle\sub1\sub2\BestOfferArrayType | All best offers for the item according to the filter or best offer id (or both) used in
