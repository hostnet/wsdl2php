...
class EndOfAuctionEmailPreferencesType
{
	...
	public $templatetext;
	/**
	 * @var \Controle\sub1\sub2\anyURI | The URL of the logo to include in the customized email.
	 */
	public $logourl;
	/**
	 * @var \Controle\sub1\sub2\EndOfAuctionLogoTypeCodeType | The type of logo to include in the customized email.
	 */
	public $logotype;
	/**
