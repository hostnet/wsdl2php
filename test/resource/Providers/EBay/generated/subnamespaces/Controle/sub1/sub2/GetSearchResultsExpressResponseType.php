 ...
 */
class GetSearchResultsExpressResponseType extends \Controle\sub1\sub2\AbstractResponseType {
	/**
	 * @var \Controle\sub1\sub2\DomainHistogramType | Indicates the quantity of items and catalog products that fall into departments, aisles,
	...
	public $ItemArray;
	/**
	 * @var \Controle\sub1\sub2\ProductArrayType | Contains a list of eBay catalog products have been used to pre-fill listings that match
