...
class ProductFamilyType
{
	...
	/**
	 * @var \Controle\sub1\sub2\ProductType | A transient header that describes the current search results. Contains a             an
	...
	/**
	 * @var \Controle\sub1\sub2\ProductType | A set of products (within the same product family) that match the search query.
	 */
