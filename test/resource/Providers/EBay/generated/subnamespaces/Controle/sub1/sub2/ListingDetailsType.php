...
class ListingDetailsType
{
	...
	/**
	 * @var \Controle\sub1\sub2\AmountType | Converted value of the BuyItNowPrice in the currency of the site that returned this response. For
	 * active items, refresh this value every 24 hours to pick up the current conversion rates.
	 */
	public $convertedbuyitnowprice;
	/**
	 * @var \Controle\sub1\sub2\AmountType | Converted value of the StartPrice in the currency of the site that returned this response. For
	 * active items, refresh this value every 24 hours to pick up the current conversion rates.
	 */
	public $convertedstartprice;
	/**
	 * @var \Controle\sub1\sub2\AmountType | Converted value of the ReservePrice in the currency of the site that returned this response.
	...
	public $regionname;
	/**
	 * @var \Controle\sub1\sub2\ItemIDType | Indicates the new item ID for a re-listed item. When an item is re-listed, the item ID
	...
	/**
	 * @var \Controle\sub1\sub2\ItemIDType | The item ID for the original listing from which a second chance offer is made. This value
	...
	public $endtime;
	/**
	 * @var \Controle\sub1\sub2\anyURI | The URL of the Web page where a user can view the listing. On the US site, this is called
	...
	/**
	 * @var \Controle\sub1\sub2\SellerBusinessCodeType | Type of seller account. This value is returned if the German site (site ID 77) or eBay
	 * Motors site (site ID 100) is specified.
	 */
	public $sellerbusinesstype;
	/**
	 * @var \Controle\sub1\sub2\AmountType | Specifies the minimum acceptable best offer price. If a buyer submits a best offer that
	...
	/**
	 * @var \Controle\sub1\sub2\ItemIDType | Indicates the item ID of the original item listing from which a Transaction Confirmation
	 * Request (TCR) was created. This value is only returned when the data for a TCR is retrieved.
	 */
	public $tcroriginalitemid;
	/**
	 * @var \Controle\sub1\sub2\anyURI | This URL takes you to the same View Item page as ViewItemURL, but this URL is optimized
