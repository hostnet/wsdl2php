...
class ProductSearchType
{
	...
	/**
	 * @var \Controle\sub1\sub2\SearchAttributesType | A query consisting of a set of attributes (search criteria). If the query             includes
	...
	/**
	 * @var \Controle\sub1\sub2\CharacteristicSetIDsType | List of one or more characteristic set IDs that indicate which characteristic sets
