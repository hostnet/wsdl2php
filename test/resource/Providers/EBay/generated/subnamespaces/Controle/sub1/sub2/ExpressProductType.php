...
class ExpressProductType
{
	...
	public $MaxPrice;
	/**
	 * @var \Controle\sub1\sub2\anyURI | Fully qualified URL for a standard image (if any) that is associated with the product. A
	...
	/**
	 * @var \Controle\sub1\sub2\NameValueListArrayType | A list of attribute and value pairs that are included in the product's pre-filled Item
