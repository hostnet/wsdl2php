...
class AccountEntryType {
	/**
	 * @var \Controle\sub1\sub2\AccountDetailEntryCodeType | Indicates the type of transaction or reason for the transaction. For example, a value of
	...
	public $Balance;
	/**
	 * @var \Controle\sub1\sub2\AmountType | Previous behavior: Credit amount for the entry. Returns 0.00 if the entry is a debit.
	 */
	public $Credit;
	/**
	...
	public $Date;
	/**
	 * @var \Controle\sub1\sub2\AmountType | Previous behavior: Debit amount for the entry. Returns 0.00 if the entry is a credit.
	 */
	public $Debit;
	/**
	 * @var \Controle\sub1\sub2\AmountType | Gross fees that are assessed by eBay (net fees plus VAT, if any). Returned even if VAT
	...
	public $Memo;
	/**
	 * @var \Controle\sub1\sub2\AmountType | Net fees that are assessed by eBay, excluding additional surchargesand VAT (if any). Returned
