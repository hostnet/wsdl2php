...
class InternationalShippingServiceOptionsType {
    ...
    /**
     * @var \Controle\AmountType | The cost of shipping each additional item beyond the first item. For input, this is
    ...
    /**
     * @var \Controle\AmountType | The insurance cost associated with shipping a single item with this shipping service.
