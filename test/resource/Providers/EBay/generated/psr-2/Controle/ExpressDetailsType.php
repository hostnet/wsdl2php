...
class ExpressDetailsType {
    /**
     * @var \Controle\anyURI | Large gallery image that appears in the "Grid View" in search results on the Express
    ...
    /**
     * @var \Controle\anyURI | Small gallery image that appears in the "List View" in search results on the Express
