...
class BestOfferDetailsType
{
    ...
    /**
     * @var \Controle\AmountType | (GetMyeBayBuying only) Indicates the latest BestOffer the user has provided for the
     * item .
     */
    public $BestOffer;
    /**
    ...
    /**
     * @var \Controle\BestOfferTypeCodeType | Indicates the best offer type of the latest BestOffer the user has provided for the
     * item .
     */
