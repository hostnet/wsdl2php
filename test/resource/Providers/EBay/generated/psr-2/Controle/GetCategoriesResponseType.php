 ...
 * to the next).
 */
class GetCategoriesResponseType extends \Controle\AbstractResponseType {
    /**
     ...
     * normally allow sellers to specify reserve prices. The Category.ORPA (override reserve
     * price allowed) field can override (or toggle) the reserve price allowed setting for
     * a given category. For example, if ReservePriceAllowed is false and Category.ORPA is
     * true, the category overrides the site setting and supports reserve prices. If ReservePriceAllowed
     ...
     * allow sellers to reduce an item's reserve price. The Category.ORRA (override reduce
     * reserve price) field can override (or toggle) the reserve price reduction setting for
     * a given category. For example, if ReduceReserveAllowed is false and Category.ORRA is
     * true, the category overrides the site setting and supports reducing reserve prices. If
