 ...
 */
class GetUserPreferencesResponseType extends \Controle\AbstractResponseType {
    /**
     * @var \Controle\BidderNoticePreferencesType | The user's bidder notice preferences to be set.
     */
    public $BidderNoticePreferences;
    /**
     * @var \Controle\CombinedPaymentPreferencesType | The user's combined payment preferences to be set. When you change these preferences,
    ...
    /**
     * @var \Controle\CrossPromotionPreferencesType | The user's cross promotion preferences to be set.
     */
    public $CrossPromotionPreferences;
    /**
     * @var \Controle\SellerPaymentPreferencesType | The user's seller payment preferences to be set.
     */
    public $SellerPaymentPreferences;
    /**
     * @var \Controle\SellerFavoriteItemPreferencesType | Seller's favorite item preferences to be set.
     */
    public $SellerFavoriteItemPreferences;
    /**
     * @var \Controle\EndOfAuctionEmailPreferencesType | The seller's end of auction email preferences to be set.
     */
    public $EndOfAuctionEmailPreferences;
    /**
     * @var \Controle\eBxOptInPreferenceType | If true: The seller wants their eligible eBay listings to be included on eBay Express
    ...
    /**
     * @var \Controle\ExpressPreferencesType | The seller's Express preferences. Currently used to indicate which of the seller's eligible
