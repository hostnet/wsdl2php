...
class SellerType
{
    ...
    /**
     * @var \Controle\SchedulingInfoType | Container for scheduling limits for the user. Conveys the minimum and maximum minutes
    ...
    /**
     * @var \Controle\ProStoresCheckoutPreferenceType | Details about the checkout preferences related to the ProStores store. Returned only
     * if set.
     */
