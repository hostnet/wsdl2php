...
class ProductSearchPageType
{
    ...
    public $DataElements;
    /**
     * @var \Controle\CharacteristicsSetType | A list of attributes that describe the choice of search criteria          for the specified
    ...
    /**
     * @var \Controle\CharacteristicsSearchCodeType | Indicates whether one attribute or multiple attributes can be used as the search keyword
    ...
    public $SearchType;
    /**
     * @var \Controle\CharacteristicType | A product aspect or feature that can be used as a key for sorting catalog search results.
    ...
    /**
     * @var \Controle\DataElementSetType | Contains helpful hints for the user. Usage of this information is optional.
     */
