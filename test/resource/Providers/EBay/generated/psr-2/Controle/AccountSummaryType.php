...
class AccountSummaryType
{
    ...
    /**
     * @var \Controle\AmountType | Specifies fees incurred since the last invoice, including tax if applicable. Returned
    ...
    public $InvoiceDate;
    /**
     * @var \Controle\AmountType | Amount of last payment posted, 0.00 if no payments posted. With compatibility level
