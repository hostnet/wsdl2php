...
class ProductListingDetailsType
{
     ...
     * it is used at the top of the View Item page and in the Item Specifics section of the
     * listing. If you also include Item.PictureDetails.PictureURL, the stock photo only appears
     * in the Item Specifics section of the listing. Other pictures you specify by using Item.PictureDetails.PictureURL
     * appear in a separate section of the listing. If you use Item.ExternalProductID instead
     * of Item.ProductListingDetails, eBay sets IncludeStockPhotoURL to true (and you cannot
     * set it to false). In GetItem, the URL of the stock photo will be returned in StockPhotoURL. If
     * you set IncludeStockPhotoURL to false, the stock photo does not appear in the listing
     * at all.<br> <br> To be considered for eBay Express, in most cases a listing must include
     ...
     * must be passed in with a value of Gallery or Gallery Featured (but not both). Passing
     * in Item.PictureDetails.GalleryURL takes precedence over UseStockPhotoURLAsGallery. See
     * the eBay Web Services Guide for additional validation rules for pictures. To be considered
     * for eBay Express, in most cases a listing must include a picture or a gallery URL. You
