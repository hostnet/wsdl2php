...
class ExpressSellerRequirementsType
{
    ...
    public $GoodStanding;
    /**
     * @var \Controle\FeedbackRequirementsType | The aggregate feedback score for a user. A user's feedback score is the net positive
    ...
    /**
     * @var \Controle\FeedbackRequirementsType | If true, indicates that the seller meets the Express site's minimum positive feedback
