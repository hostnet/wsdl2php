...
class TransactionType {
    /**
     * @var \Controle\AmountType | The amount the buyer paid for the item(s) in the transaction. If the seller allowed
    ...
    public $AmountPaid;
    /**
     * @var \Controle\AmountType | Adjustment amount entered by the buyer. A positive amount indicates the amount is an
    ...
    /**
     * @var \Controle\AmountType | Converted value of AmountPaid in the currency of the site that returned the response.
     * Refresh this value every 24 hours to pick up the current conversion rates. Not applicable
     * to Half.com.
     */
    ...
    public $CreatedDate;
    /**
     * @var \Controle\DepositTypeCodeType | Deposit type for US eBay Motors items. If item is not a Motors item, then returns an
    ...
    /**
     * @var \Controle\TransactionStatusType | Indicates the user's registration/user status. To be eligible to list on Express, a
    ...
    public $VATPercent;
    /**
     * @var \Controle\ExternalTransactionType | A PayPal transaction that relates to this eBay transaction. Returned only if there is
    ...
    /**
     * @var \Controle\PaidStatusCodeType | Specifies the transaction's paid status, as seen by the buyer. Returned in lists of
     * won and sold items. Not applicable to Half.com.
     */
    public $BuyerPaidStatus;
    /**
     * @var \Controle\PaidStatusCodeType | Specifies the transaction's payment status, as seen by the seller. Returned in lists
    ...
    /**
     * @var \Controle\TransactionPlatformType | Indicates the platform the item was purchased on (such as eBay or eBay Express). Not
     * applicable to Half.com.
     */
