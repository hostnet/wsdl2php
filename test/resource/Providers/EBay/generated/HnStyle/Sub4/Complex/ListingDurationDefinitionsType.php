...
class ListingDurationDefinitionsType
{
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\ListingDurationDefinitionType | Specifies the ID of a set of default durations for a certain type of listing. The actual
