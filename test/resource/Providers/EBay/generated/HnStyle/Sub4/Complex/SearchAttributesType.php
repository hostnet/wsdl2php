...
class SearchAttributesType
{
    ...
    public $AttributeID;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\DateSpecifierCodeType | Specifies the date sub-component that the attribute represents. This only applies to
     * date attributes. Required when searching by date attributes.            Allows for separate
     * text fields or drop-down lists to be rendered for            each sub-component. For
     * example, the day, month, and year can be rendered as            separate drop-down lists.
     * See DateSpecifierCodeType for possible values.
     */
    public $DateSpecifier;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\RangeCodeType | Indicates that the attribute represents the high or low end in a range, such as a date
     * range or a price range. Required when searching on ranges.
     */
    public $RangeSpecifier;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\ValType | Container for the list of one or more valid values that the user has selected for the
