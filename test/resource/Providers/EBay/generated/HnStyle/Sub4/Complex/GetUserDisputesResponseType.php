 ...
 \Controle\Hostnet\Namesp\Sub4\Complex\AbstractResponseType
{
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\DisputeIDType | The index of the first dispute in the current result set, relative to the total number
     * of disputes available. Primarily useful for interpreting paginated results. For example,
     * if 228 disputes are available and 200 results are returned per page: The first page
     * returns a StartingDisputeID value of 1 and the second page returns a StartingDisputeID
     * value of 201.
     */
    public $StartingDisputeID;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\DisputeIDType | The index of the last dispute in the current result set, relative to the total number
     * of disputes available. Primarily useful for interpreting paginated results. For example,
     * if 228 disputes are available and 200 results are returned per page: The first page
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\DisputeArrayType | The array of disputes returned.
     */
    public $DisputeArray;
    /**
    ...
    public $PageNumber;
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\DisputeFilterCountType | The number of disputes that involve the requester as buyer or seller and match a given
     * filter type.
     */
