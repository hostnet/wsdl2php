...
class PaymentDetailsType
{
     ...
     * specified a deposit). Only takes effect if listing also includes the Deposit Amount
     * and Deposit Type attributes (see AttributeSetArray). The choices are 24, 48, and 72,
     ...
     * to pay the full cost of the vehicle. The choices are 3, 7, 10, and 14, and the default
     * is 7. PayPal and credit cards cannot be used to pay the full cost of a vehicle, so the
