...
class SellingSummaryType
{
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\AmountType | The total value of all items the user has for sale in all listings.
     */
    ...
    /**
     * @var \Controle\Hostnet\Namesp\Sub4\Complex\AmountType | The total monetary value of the items the user has sold.
     */
