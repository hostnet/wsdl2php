...
class SellerSearch
{
	...
	{
        $this->SellerSearchDetails = (SellerSearchDetailsArray)$val;
	}
}
...
class ListingProductInfo
{
	...
	{
        $this->ListingProductDetails = (ListingProductDetailsArray)$val;
	}
}
...
class ModifyShoppingCartItemsRequest
{
	...
	public function setItems($val)
	{
        $this->Items = (ItemQuantityArray)$val;
	}
